...
@Component
public class AdministratorDeactivateAccountValidator extends
    CommonUserAccountValidator {

  @Override
  protected void performCustomValidation(ValidationResult validationResult,
      HttpServletRequest request) {
    AdministratorDeactivateAccountRequestParameters requestParameters = (AdministratorDeactivateAccountRequestParameters) validationResult
        .getValidatedRequest();
