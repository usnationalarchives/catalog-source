...
@Component
public class CommentsModifyByIdValidator extends AnnotationsCommonValidator  {
	...
	public void performCustomValidation(ValidationResult validationResult,
		...
		AnnotationsModifyByIdRequestParameters requestParameters = 
				(AnnotationsModifyByIdRequestParameters) validationResult
				.getValidatedRequest();
